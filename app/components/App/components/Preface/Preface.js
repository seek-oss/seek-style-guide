  ...
  return (
    <GridContainer>
      <section className={styles.root}>
        ...
        <div className={styles.columns}>
          <div className={styles.column}>
            ...
            <div className={styles.section}>
              <h2 className={styles.principle}>Design with empathy</h2>
              <p className={styles.p}>Understand our customers and end users better than they understand themselves</p>
            </div>

            <div className={styles.section}>
              <h2 className={styles.principle}>A Seek interaction is transparent, honest and trustworthy</h2>
            ...
            <div className={styles.section}>
              <h2 className={styles.principle}>Use persuasive design to achieve business goals</h2>
      ...
      it should be used in a way that encourages users towards the goals of SEEK. A registered user action is more valuable than an anonymous one, a searchable profile is more useful than a hidden one.</p>
            ...
            <div className={styles.section}>
              <h2 className={styles.principle}>Content is king</h2>
          ...
          <div className={styles.column}>
            <div className={styles.section}>
              <h2 className={styles.principle}>Simplicity is powerful</h2>
            ...
            <div className={styles.section}>
              <h2 className={styles.principle}>Data informs design</h2>
            ...
            <div className={styles.section}>
              <h2 className={styles.principle}>Consistency matters</h2>
              ...
              <div className={styles.section}>
                <h2 className={styles.principle}>Accessibile design is good design</h2>
          ...
          <div className={styles.column}>
            ...
            <div className={styles.section}>
              <h2 className={styles.principle}>Make it mine</h2>
            ...
            <div className={styles.section}>
              <h2 className={styles.principle}>Don&rsquo;t make users think</h2>
