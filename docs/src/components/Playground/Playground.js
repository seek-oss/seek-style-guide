    ...
    return (
      <div>
        ...
        <PageBlock>
          ...
          <Columns>
            {[StarIcon, ProfileIcon, HeartIcon, ThumbsUpIcon].map(
              (IconComponent, index) => (
                <Card key={index}>
                  <Section>
                  ...
                  {[
                    ...
                    <div key={size}>
                      ...
                      <Text {...{ [size]: true }}>
                        {' '}
                        {`${capitalize(size)}${
                          showTextRating ? ' with text rating' : ''
                        }`}
                      </Text>
                      <br />
                    </div>
          ...
          <Card>
            <Section>
              {typographySizes.map(size => (
                <div key={size}>
                  <Text {...{ [size]: true }}>
                    Lorem ipsum <StarIcon {...{ [size]: true }} /> dolor sit
                    amet, <ThumbsUpIcon {...{ [size]: true }} /> consectetur
                    adipiscing <HeartIcon {...{ [size]: true }} /> elit. Nam vel
                    sapien lorem.
                  </Text>
                  <br />
                </div>
