          ...
          <div className={styles.row}>
            <div className={styles['col-md-4']}>
              <div className={styles.row}>
                ...
                <div className={classnames(styles['col-xs-12'],styles['col-sm-6'],styles['col-md-12'])}>
                  <div className={styles.row}>
                    <div className={classnames(styles['col-xs-6'],styles['col-xs-push-6'],styles['col-sm-12'],styles['col-sm-push-0'],styles['footer-contact-info'])}>
                    ...
                    <div className={classnames(styles['col-xs-6'],styles['col-xs-pull-6'],styles['col-sm-12'],styles['col-sm-pull-0'])}>
